...
export const Policy = () => {
  return (
    <>
      ...
      복합기,복사기 임대 전문업체은(는) 이용자들의 개인정보보호를 매우 중요시하며, 이용자가 회사의 서비스를
      이용함과 동시에 온라인상에서 회사에 제공한 개인정보가 보호 받을 수 있도록 최선을 다하고
      있습니다. 이에 복합기,복사기 임대 전문업체(주)는 통신비밀보호법, 전기통신사업법, 정보통신망 이용촉진 및 정보보호 등에
      관한 법률 등 정보통신서비스제공자가 준수하여야 할 관련 법규상의 개인정보보호 규정 및
      정보통신부가 제정한 개인정보보호지침을 준수하고 있습니다. 복합기,복사기 임대 전문업체(주)는 개인정보 처리방침을 통하여
      이용자들이 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해
      어떠한 조치가 취해지고 있는지 알려 드립니다

      복합기,복사기 임대 전문업체(주)는 개인정보 처리방침을 홈페이지 첫 화면에 공개함으로써 이용자들이 언제나 용이하게 보실
      수 있도록 조치하고 있습니다.
      ...
      복합기,복사기 임대 전문업체(주)의 개인정보 처리방침은 다음과 같은 내용을 담고 있습니다.
      ...
      복합기,복사기 임대 전문업체(주)는 이용자들이 회사의 개인정보 처리방침 또는 이용약관의 내용에 대하여 「동의」버튼 또는
      ...
      그러나 복합기,복사기 임대 전문업체(주)는 회원서비스를 통하여 이용자들에게 맞춤식 서비스를 비롯한 보다 더 향상된 양질의
      서비스를 제공하기 위하여 이용자 개인의 정보를 수집하고 있습니다.

      복합기,복사기 임대 전문업체(주)는 이용자의 사전 동의 없이는 이용자의 개인 정보를 공개하지 않으며, 수집된 정보는 아래와
      같이 이용하고 있습니다.

      첫째, 이용자들이 제공한 개인정보를 바탕으로 보다 더 유용한 서비스를 개발할 수 있습니다.
      복합기,복사기 임대 전문업체(주)는 신규 서비스개발이나 컨텐츠의 확충 시에 기존 이용자들이 회사에 제공한 개인정보를
      바탕으로 개발해야 할 서비스의 우선 순위를 보다 더 효율적으로 정하고, 복합기,복사기 임대 전문업체(주)는 이용자들이 필요로
      ...
      복합기,복사기 임대 전문업체(주)는 이용자들이 회원서비스를 이용하기 위해 회원으로 가입하실 때 서비스 제공을 위한 필수적인
      ...
      이용자가 쇼핑몰 회원으로서 회사에 제공하는 서비스를 이용하는 동안 복합기,복사기 임대 전문업체(주)는 이용자들의 개인정보를
      ...
      보존할 필요가 있는 경우 복합기,복사기 임대 전문업체(주)는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
      이 경우 복합기,복사기 임대 전문업체(주)는 복합기,복사기 임대 전문업체(주)는 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다.

      - 계약 또는 청약철회 등에 관한 기록 : 5년
      - 대금결제 및 재화 등의 공급에 관한 기록 : 5년
      - 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년

      복합기,복사기 임대 전문업체(주)는 귀중한 회원의 개인정보를 안전하게 처리하며, 유출의 방지를 위하여 다음과 같은 방법을
      통하여 개인정보를 파기합니다.
      ...
      복합기,복사기 임대 전문업체(주)는 이용자들의 개인정보를 "2. 개인정보의 수집목적 및 이용목적"에서 고지한 범위 내에서
      ...
      신고할 수 있고, 복합기,복사기 임대 전문업체(주)는 이용자들의 신고사항에 대하여 신속하고도 충분한 답변을 해 드릴
      것입니다.
      ...
      있습니다. 복합기,복사기 임대 전문업체(주)는 비밀번호에 대해 어떠한 방법으로도 이용자에게 직접적으로 질문하는 경우는
      없으므로 타인에게 비밀번호가 유출되지 않도록 각별히 주의하시기 바랍니다.
      특히 공공장소에서 온라인상에서 접속해 있을 경우에는 더욱 유의하셔야 합니다.
      복합기,복사기 임대 전문업체(주)는 개인정보에 대한 의견수렴 및 불만처리를 담당하는 개인정보 보호책임자 및 담당자를
      지정하고 있고, 연락처는 아래와 같습니다.

      이　　　 름 : 이상철
      소속 / 직위　: 대표 대표
      E-M A I L 　 : oasvcplaza@naver.com
      전 화 번 호　: 031-571-0913


      12. 아동의 개인정보보호
      복합기,복사기 임대 전문업체는 온라인 환경에서 만 14세 미만 어린이의 개인정보를 보호하는 것 역시 중요한 일이라고 생각하고 있습니다.
      복합기,복사기 임대 전문업체는 만 14세 미만의 어린이들은 법정대리인의 동의가 없는 한 회원으로 가입할 수 없게 하고 있습니다. 즉, 만 14세 미만의 어린이들은 법정대리인의 동의가 있을 때만 복합기,복사기 임대 전문업체에서 회원 자격의 서비스를 받을 수 있습니다.
...
export const PersonalPolicyMore = () => {
    ...
    <>
      <div className="flex justify-start w-full">
        <Input
          type={"checkbox"}
          labelCss={"w-[140px]"}
          cssProps="!border-none shadow-none mr-[20px]"
          placeholder={"개인정보 동의"}>
          개인정보 동의
        </Input>
        {click === false ?
          <button
            className="flex justify-start items-center gap-x-[10px] w-[80px] text-start cursor-pointer text-[#807e7e]"
            onClick={() => setClick(true)}>
            더보기
            <BiSolidDownArrow className="w-[12px]" />
          </button>
          :
          <button
            className="flex justify-start items-center gap-x-[10px] w-[80px] text-start cursor-pointer text-[#807e7e]"
            ...
            접기
            <BiSolidUpArrow className="w-[12px]" />
          </button>
        }
      ...
      {click &&
        <>
          <p>개인정보 수집동의</p>
          <ul className="border border-solid border-black p-[30px] text-[#565353]">
            <li>- 수집항목: 이름, 전화번호, 이메일주소</li>
            <li>- 수집/이용목적: 게시글 접수 및 결과 회신</li>
            <li>- 이용기간: 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.</li>
            <li>단, 관계법령의 규정에 의하여 보전할 필요가 있는 경우 일정기간 동안 개인정보를 보관할 수 있습니다.</li>
            <li>그 밖의 사항은 (주) 000 개인정보처리방침을 준수합니다.</li>
          </ul>
        </>
      }
